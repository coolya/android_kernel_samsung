...
#define GPIO_BLOW_PCM_SYNC		S5PV210_GPC1(2)

#define GPIO_BLOW_PCM_IN		S5PV210_GPC1(3)

#define GPIO_BLOW_PCM_OUT		S5PV210_GPC1(4)
#else
...
#if (defined CONFIG_ARIES_VER_B0) || (defined CONFIG_ARIES_VER_B1) || (defined CONFIG_ARIES_VER_B2)
#define GPIO_VIBTONE_PWM		S5PV210_GPD0(1)
#else
#ifdef CONFIG_JUPITER_VER_B5
#define GPIO_VIBTONE_PWM2		S5PV210_GPD0(1)
#else
#define GPIO_GPD01				S5PV210_GPD0(1)
#endif
#endif
...
#define GPIO_AP_SDA_29V			S5PV210_GPD1(4)
#define GPIO_AP_SDA_29V_AF		2	

#define GPIO_AP_SCL_29V			S5PV210_GPD1(5)
...
#else
#define GPIO_GYRO_HP			S5PV210_GPE1(4)
#endif
...
#else
#define GPIO_GPF34				S5PV210_GPF3(4)
#endif
...
#define GPIO_GYRO_PD			S5PV210_GPH0(5)
#endif
...
#else
#define GPIO_PS_VOUT			S5PV210_GPH1(2)
#define GPIO_PS_VOUT_AF		0xFF
#endif
...
#define GPIO_TA_nSTAT			S5PV210_GPH1(6)
#endif
...
#define GPIO_GPJ00				S5PV210_GPJ0(0)
#else
#define GPIO_PDA_ACTIVE			S5PV210_GPJ0(0)
#endif
...
#else
#define GPIO_USB_SEL30			S5PV210_GPJ0(7)
#endif
...
#else
#define GPIO_VIBTONE_EN2		S5PV210_GPJ1(2)
#endif
#else
#define GPIO_VIBTONE_EN1		S5PV210_GPJ1(1)
...
#else
#define GPIO_EAR_SEL			S5PV210_GPJ1(4)
#endif
...
#else
#define GPIO_EAR35_SW			S5PV210_GPJ3(1)
#endif
...
#else
#define GPIO_IrDA_SHUTDOWN		S5PV210_GPJ3(4)

#define GPIO_ALS_nRST			S5PV210_GPJ3(5)
...
#else
#define GPIO_KEY_LED_ON			S5PV210_GPJ4(1)
#endif
#endif
...
#else
#define GPIO_CODEC_LDO_EN		S5PV210_MP03(6)
#endif
...
#else
#define GPIO_MHL_USB_SEL		S5PV210_MP05(0)
