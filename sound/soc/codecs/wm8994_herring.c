...
//extern short int get_headset_status(void);		// For ear-jack control(MIC-Bias)//..not present in 32 kernel now
...
int audio_init(void)
{
...
#if (defined CONFIG_JUPITER_VER_B5) || (defined CONFIG_ARIES_VER_B0) || (defined CONFIG_MACH_S5PC110_ARIES)
	...
	// PCM_SEL Setting
#if  (defined CONFIG_JUPITER_VER_B5) || (defined CONFIG_ARIES_VER_B0) || (defined CONFIG_ARIES_VER_B1) || (defined CONFIG_MACH_S5PC110_ARIES)
...
#if (defined CONFIG_JUPITER_VER_B5)  || (defined CONFIG_ARIES_VER_B0) || (defined CONFIG_ARIES_VER_B1) || (defined CONFIG_ARIES_VER_B2) || (defined CONFIG_ARIES_VER_B3) || (defined CONFIG_MACH_S5PC110_P1) || (defined CONFIG_MACH_S5PC110_ARIES) || (defined CONFIG_MACH_S5PC110_CRESPO)
...
void audio_ctrl_mic_bias_gpio(int enable)
{
	...
	else
	{
		...
		//headset_state = get_headset_status();// ...not present in 32 kernel as of now
